...
export const useOnlineChatStore = defineStore('onlineChatStore',() => {
    ...
    return ({ userid, userqq, logind, username, onlineUser, connection, chatChannel, setUserId, setUserQQ, setLogind, setUserName, setConnection, setOnlineUsers, setChatChannel });
});